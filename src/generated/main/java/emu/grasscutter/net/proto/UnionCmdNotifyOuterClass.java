...
public final class UnionCmdNotifyOuterClass {
  ...
  public interface UnionCmdNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .UnionCmd cmd_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CMD_LIST_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < cmdList_.size(); i++) {
        output.writeMessage(4, cmdList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < cmdList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, cmdList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\016UnionCmdNotify\022\033\n\010cmd_list\030\004 \003(\0132\t.Uni" +
